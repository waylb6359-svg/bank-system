...
1. First Time Setup screen appears automatically
2. Create the **first Admin account** (Name, Password, Salary)
3. System assigns **ID = 1**
4. Login with the new Admin credentials
5. Start adding **Employees and Clients**
...
1,Ahmed,12345678,5000
2,Mohamed,12345678,3000


### Employee.txt

1,Sara,12345678,7000
2,Khaled,12345678,8000
...
6. Start using the banking system
